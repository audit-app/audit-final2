...
export class InitialMigration1770496454514 implements MigrationInterface {
    name = 'InitialMigration1770496454514'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f516a7b27963221eb7884e4e4d" ON "audits" ("code") `);
        await queryRunner.query(`CREATE INDEX "IDX_dcdadf36d0fd457e25d79af6e4" ON "audits" ("parentAuditId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9d388ca6ecd0a7da43c3fe144e" ON "audits" ("templateId") `);
        await queryRunner.query(`CREATE INDEX "IDX_445f43a364befa850e2b361d0b" ON "audits" ("organizationId", "status") `);
        ...
        await queryRunner.query(`ALTER TABLE "audit_assignments" ADD CONSTRAINT "FK_11046548f77717c3ce082c9c4a3" FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_assignments" ADD CONSTRAINT "FK_b3ea84d815a4c8a636f06f641e0" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_work_papers" ADD CONSTRAINT "FK_39bfa34ea5ae1f4380a6b18c53f" FOREIGN KEY ("responseId") REFERENCES "audit_responses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_responses" ADD CONSTRAINT "FK_7231d2819650a1d7fe8dba8a769" FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_responses" ADD CONSTRAINT "FK_048476adb83499b0e0503c4f5a1" FOREIGN KEY ("standardId") REFERENCES "standards"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "audits" ADD CONSTRAINT "FK_314b932d31c60b010830ab9ae4a" FOREIGN KEY ("frameworkId") REFERENCES "maturity_frameworks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "audit_responses" DROP CONSTRAINT "FK_048476adb83499b0e0503c4f5a1"`);
        await queryRunner.query(`ALTER TABLE "audit_responses" DROP CONSTRAINT "FK_7231d2819650a1d7fe8dba8a769"`);
        await queryRunner.query(`ALTER TABLE "audit_work_papers" DROP CONSTRAINT "FK_39bfa34ea5ae1f4380a6b18c53f"`);
        await queryRunner.query(`ALTER TABLE "audit_assignments" DROP CONSTRAINT "FK_b3ea84d815a4c8a636f06f641e0"`);
        await queryRunner.query(`ALTER TABLE "audit_assignments" DROP CONSTRAINT "FK_11046548f77717c3ce082c9c4a3"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_445f43a364befa850e2b361d0b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9d388ca6ecd0a7da43c3fe144e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dcdadf36d0fd457e25d79af6e4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f516a7b27963221eb7884e4e4d"`);
        await queryRunner.query(`DROP TABLE "audits"`);
        await queryRunner.query(`DROP TYPE "public"."audits_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4b693538386fe941c96fd271e6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cdfe57f874fcd7147586cf212f"`);
        await queryRunner.query(`DROP TABLE "audit_responses"`);
        await queryRunner.query(`DROP TYPE "public"."audit_responses_compliancelevel_enum"`);
        await queryRunner.query(`DROP TYPE "public"."audit_responses_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_39bfa34ea5ae1f4380a6b18c53"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_21a652e344818944795ec8f77c"`);
        await queryRunner.query(`DROP TABLE "audit_work_papers"`);
        await queryRunner.query(`DROP TYPE "public"."audit_work_papers_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_11046548f77717c3ce082c9c4a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b3ea84d815a4c8a636f06f641e"`);
