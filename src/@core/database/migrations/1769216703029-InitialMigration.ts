...
export class InitialMigration1769216703029 implements MigrationInterface {
    name = 'InitialMigration1769216703029'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_b029e60d94144a8e297c986390" ON "organizations" ("name") WHERE "deletedAt" IS NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ca09157b626285881a55fed3a5" ON "organizations" ("nit") WHERE "deletedAt" IS NULL`);
        await queryRunner.query(`CREATE TYPE "public"."users_roles_enum" AS ENUM('admin', 'gerente', 'auditor', 'cliente')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_933a628626fb656576d0d4c426" ON "users" ("ci") WHERE "deletedAt" IS NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_3a12b4d06d4b521030f5211d51" ON "maturity_levels" ("frameworkId", "level") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('CREATE', 'UPDATE', 'DELETE', 'ARCHIVE', 'ACTIVATE', 'DEACTIVATE', 'PUBLISH')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_48d2129883c2b415dfdff021e3" ON "audit_logs" ("rootId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_00f40b2db1b92c0afb3f8e4e00" ON "audit_logs" ("rootId", "createdAt") `);
        ...
        await queryRunner.query(`ALTER TABLE "maturity_levels" ADD CONSTRAINT "FK_2d5ac37a26afd5bfc1d58c1912b" FOREIGN KEY ("frameworkId") REFERENCES "maturity_frameworks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_00f40b2db1b92c0afb3f8e4e00"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_48d2129883c2b415dfdff021e3"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_3a12b4d06d4b521030f5211d51"`);
        await queryRunner.query(`DROP TABLE "maturity_levels"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_616304b2113f3fc4a5b67a5710"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_933a628626fb656576d0d4c426"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`DROP TYPE "public"."users_roles_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ca09157b626285881a55fed3a5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b029e60d94144a8e297c986390"`);
